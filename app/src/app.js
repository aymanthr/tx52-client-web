...
angular
    ...
    .module('mainApp', ['ngMaterial', 'ngRoute', 'btford.markdown', 'ngMdIcons', 'ngProgress'])
    ...
    .config(function($mdThemingProvider, $mdIconProvider, $routeProvider){
        ...
        $routeProvider
            ...
            .when('/learning/list', {
                templateUrl: 'src/Learning/views/list-courses.html',
                controller: 'LearningController'
            })
        ...
        .constant('appConfig', {
        'backend': 'http://localhost/tx52-server-web-symfony/web/api/v1',
        'version': 0.1
    })
;
